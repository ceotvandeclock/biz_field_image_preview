...
odoo.define('image.legacy.mail.DocumentViewer', function (require) {
    ...
    var DocumentViewer = Widget.extend({
        template: "image.legacy.mail.DocumentViewer",
        events: {
...
odoo.define('biz_field_image_preview.image_widget_extend', function (require) {
    "use strict";
    ...
    imageWidget.include({
        _render: function () {
            this._super.apply(this, arguments);
            var self = this;
            if(self.attrs.context && self.attrs.context=="{'show_preview_image': True}"){
